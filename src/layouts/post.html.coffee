...
article id: @document.id, class: "post hentry", ->
  ...
  div class: "entry-content", ->
    if @document.thumbnail?
      img src: @getUrl("/img/placeholder.gif"), 'data-original': @document.thumbnail[0], class: "lazy alignthumb", alt: @document.thumbnail[1] if @document.thumbnail[1]?
      noscript ->
        img src: @document.thumbnail[0], class: "alignthumb", alt: @document.thumbnail[1] if @document.thumbnail[1]?
