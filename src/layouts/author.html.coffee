...
article id: @document.id, class: "author hentry row", ->
  div id: "img-profile", class: "col-12 col-sm-3 col-lg-3", ->
    if @document.imgprofile?
      ...
      noscript ->
        img src: @getThumbnail(@document.imgprofile, 'medium'), class: "img-responsive img-rounded", alt: "User image"
    else
      ...
      noscript ->
        img src: @getThumbnail(@getUrl("/img/userimg.jpg"), 'medium'), class: "img-responsive img-rounded", alt: "User image"
